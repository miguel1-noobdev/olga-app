...
> **Aviso: no canónico y exploratorio.** `ideas/` conserva planificación e historial; su contenido puede cambiar y no define el comportamiento implementado ni contratos de cambio aceptados.
