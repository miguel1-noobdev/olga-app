...
- [x] 5.4 Close the chain only after canonical routes pass, lifecycle invariants and legacy redirects are proven, no migration exists, and each PR records test/runtime receipts plus review gates; only then resume the Stitch visual worktree.
