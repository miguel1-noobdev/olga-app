...
export const PLANT_SEEDS: SeedPlant[] = [
  {
    commonName: 'Lavanda',
    ...
    images: [
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/e/ef/%27Lavandula_angustifolia%27_Hidcote_cultivar_Henham_Essex_England.jpg',
        alt: 'Cultivar Hidcote de Lavandula angustifolia en Henham, Essex, Inglaterra',
      },
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/9/93/Lavandula-angustifolia-flowering.JPG',
        alt: 'Flores masivas de Lavandula angustifolia',
      },
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/9/9e/LAVANDULA_ANGUSTIFOLIA_-_B%C3%92FIA_-_IB-409_%28Esp%C3%ADgol%29.JPG',
        alt: 'Lavandula angustifolia silvestre en la Bòfia, Pirineos catalanes',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    images: [
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/5/54/Aloe-vera-20080327.JPG',
        alt: 'Planta de Aloe vera en flor en Tempe, Arizona',
      },
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/c/c0/Aloe_vera.jpg',
        alt: 'Planta de Aloe vera con flor',
      },
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/d/d1/Aloe_vera_A.jpg',
        alt: 'Planta de Aloe vera en Playa del Ingles, Gran Canaria',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    images: [
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/3/32/Divlja_ruza_cvijet_270508.jpg',
        alt: 'Flor de Rosa canina en Croacia',
      },
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/3/31/Dzika_r%C3%B3%C5%BCa_owoce.jpg',
        alt: 'Frutos de Rosa canina',
      },
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/7/77/Dog_Rose.jpg',
        alt: 'Flor silvestre de Rosa canina en Staffordshire, Inglaterra',
      },
    ],
  },
  {
