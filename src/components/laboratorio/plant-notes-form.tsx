...
export default function PlantNotesForm({ initialNotes, submitPlantNotes }: PlantNotesFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} aria-label="Editar notas internas" className="space-y-4">
      <div>
        <label htmlFor="plant-notes" className="mb-2 block font-label text-xs font-bold uppercase tracking-wider text-primary">
          Notas
        </label>
        <textarea
          id="plant-notes"
